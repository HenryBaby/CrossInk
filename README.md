...
- To view a more detailed list for each version, visit the [releases](https://github.com/HenryBaby/CrossInk/releases) page to read release notes.
...
Download a `firmware-*.bin` from the [releases page](https://github.com/HenryBaby/CrossInk/releases), then flash it with the web installer or command line.
