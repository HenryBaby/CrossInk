...
namespace GrimmoryTls {

// Official Let's Encrypt trust anchors. ISRG Root X1 covers the established
// chains; Root YR directly anchors the RSA generation-Y chains introduced in
// 2026. Keeping the PEM bundle constexpr stores it in flash rather than DRAM.
inline constexpr char kLetsEncryptRoots[] = R"CERT(-----BEGIN CERTIFICATE-----
